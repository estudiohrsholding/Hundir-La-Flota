...
ASSETS = {
    ...
    'fallo': os.path.join(_BASE_DIR, 'assets', 'images', 'failshoot.png'),
    'impacto': os.path.join(_BASE_DIR, 'assets', 'images', 'wellshoot.png'),
    'barco_6': os.path.join(_BASE_DIR, 'assets', 'images', 'piezas6.png'),
    'barco_5': os.path.join(_BASE_DIR, 'assets', 'images', 'piezas5.png'),
    'barco_4': os.path.join(_BASE_DIR, 'assets', 'images', 'piezas4.png'),
    'barco_3': os.path.join(_BASE_DIR, 'assets', 'images', 'piezas3.png'),
    'barco_2': os.path.join(_BASE_DIR, 'assets', 'images', 'piezas2.png'),
    'barco_1': os.path.join(_BASE_DIR, 'assets', 'images', 'piezas1.png')
}
